...
TRAINER_MAP = {
    ...
    ("CRFTaggingGNN", "ED"): CRFTaggingGNNEDTrainer, 
    ("CRFTaggingGNN", "EAE"): CRFTaggingGNNEAETrainer, 
    ("TagPrimepp", "ED"): TagPrimeppEDTrainer, 
    ("TagPrimepp", "EAE"): TagPrimeppEAETrainer,
    ("TagCrossAttRole", "EAE"):TagCrossAttRoleEAETrainer,
